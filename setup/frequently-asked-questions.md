...
\
Another suggestion for testing alert filters is to create an alert with a small window and waited. The [API](/alerts.md#alerts-scheduler) will allow hours in the window.&#x20;
